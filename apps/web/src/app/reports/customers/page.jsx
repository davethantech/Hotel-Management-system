...
export default function CustomerReportsPage() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Customer Reports", href: "/reports/customers", active: true }
      ]
    }
  ];
  ...
  const mockAnalytics = {
    ...
    totalRevenue: 125670,
    averageSpending: 450.80,
    topSpenders: [
      { name: "John Smith", amount: 4500, bookings: 8 },
      { name: "Sarah Johnson", amount: 3200, bookings: 6 },
      { name: "Michael Chen", amount: 2800, bookings: 5 },
      { name: "Emma Wilson", amount: 2400, bookings: 4 },
      { name: "David Brown", amount: 2100, bookings: 3 }
    ],
    customerSegments: [
      { segment: "VIP Customers", count: 45, percentage: 3.6 },
      { segment: "Regular Customers", count: 312, percentage: 25.0 },
      { segment: "Occasional Customers", count: 567, percentage: 45.5 },
      { segment: "New Customers", count: 323, percentage: 25.9 }
    ],
    monthlyTrends: [
      { month: "Jan", customers: 98, revenue: 45000 },
      { month: "Feb", customers: 112, revenue: 52000 },
      { month: "Mar", customers: 134, revenue: 61000 },
      { month: "Apr", customers: 156, revenue: 68000 },
      { month: "May", customers: 189, revenue: 78000 },
      { month: "Jun", customers: 167, revenue: 72000 }
    ]
  };
        ...
        <main className="p-4 md:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
              ...
              <p className="text-[#8A94A7] dark:text-[#A0A0A0]">
                Comprehensive analytics and insights about your customers
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">{formatNumber(mockAnalytics.totalCustomers)}</p>
                </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">New Customers</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">{mockAnalytics.newCustomers}</p>
                </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Avg. Spending</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">{formatCurrency(mockAnalytics.averageSpending)}</p>
                </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Satisfaction</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">{mockAnalytics.customerSatisfaction}/5</p>
                </div>
                <div className="w-12 h-12 bg-[#FEF3C7] dark:bg-[#451A03] rounded-lg flex items-center justify-center">
                  <Star size={24} className="text-[#F59E0B] dark:text-[#FCD34D]" />
                </div>
              </div>
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">+0.2</span>
                <span className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm ml-2">vs last month</span>
              </div>
            </div>
          </div>
                  ...
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className={`w-3 h-3 rounded-full mr-3 ${
                        index === 0 ? 'bg-[#4F8BFF]' :
                        index === 1 ? 'bg-[#10B981]' :
                        index === 2 ? 'bg-[#F59E0B]' : 'bg-[#EF4444]'
                      }`}></div>
                      <span className="text-sm text-[#07111F] dark:text-[#E5E5E5]">{segment.segment}</span>
                    </div>
                    <div className="text-right">
                      <div className="text-sm font-medium text-[#07111F] dark:text-[#E5E5E5]">{segment.count}</div>
                      <div className="text-xs text-[#8A94A7] dark:text-[#A0A0A0]">{segment.percentage}%</div>
                    </div>
                  </div>
                ))}
              </div>
                      ...
                      <div className="flex-1 mx-4">
                        <div className="w-full bg-[#F1F5FF] dark:bg-[#1A2332] rounded-full h-2">
                          <div 
                            ...
                            style={{ width: `${(trend.customers / 200) * 100}%` }}
                          ></div>
                        </div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm font-medium text-[#07111F] dark:text-[#E5E5E5]">{trend.customers}</div>
                      <div className="text-xs text-[#8A94A7] dark:text-[#A0A0A0]">{formatCurrency(trend.revenue)}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] overflow-hidden mb-8" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
            <div className="px-6 py-4 border-b border-[#EDF0F4] dark:border-[#333333]">
              <div className="flex items-center justify-between">
                ...
                <TrendingUp size={20} className="text-[#8A94A7] dark:text-[#A0A0A0]" />
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-[#EDF0F4] dark:divide-[#333333]">
                  {mockAnalytics.topSpenders.map((customer, index) => (
                    <tr key={index} className="hover:bg-[#F7F9FC] dark:hover:bg-[#262626] transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-[#07111F] dark:text-[#E5E5E5]">
                          {formatCurrency(customer.amount / customer.bookings)}
                        </span>
                      </td>
                    </tr>
                  ))}
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-[#E8F0FF] dark:bg-[#1A2332] rounded-lg flex items-center justify-center mr-3">
                  <Clock size={20} className="text-[#4F8BFF] dark:text-[#5B94FF]" />
                </div>
              ...
              <p className="text-3xl font-bold text-[#07111F] dark:text-[#E5E5E5] mb-2">
                {mockAnalytics.averageStay} days
              </p>
              <p className="text-sm text-[#8A94A7] dark:text-[#A0A0A0]">
                Customers stay an average of {mockAnalytics.averageStay} days per visit
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-[#ECFDF5] dark:bg-[#064E3B] rounded-lg flex items-center justify-center mr-3">
                  <Activity size={20} className="text-[#10B981] dark:text-[#34D399]" />
                </div>
                <h3 className="text-lg font-semibold text-[#07111F] dark:text-[#E5E5E5]">
                  Returning Rate
                </h3>
              ...
              <p className="text-sm text-[#8A94A7] dark:text-[#A0A0A0]">
                {mockAnalytics.returningCustomers} customers returned this month
              </p>
            </div>

            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-[#DBEAFE] dark:bg-[#1E3A8A] rounded-lg flex items-center justify-center mr-3">
                  <CreditCard size={20} className="text-[#3B82F6] dark:text-[#60A5FA]" />
                </div>
                <h3 className="text-lg font-semibold text-[#07111F] dark:text-[#E5E5E5]">
                  Total Revenue
                </h3>
              ...
              <p className="text-sm text-[#8A94A7] dark:text-[#A0A0A0]">
                Generated from {mockAnalytics.totalCustomers} customers
              </p>
            </div>
          </div>
        </main>
