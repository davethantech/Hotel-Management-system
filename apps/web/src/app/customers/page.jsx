...
export default function CustomersPage() {
  ...
  const { data: customers, isLoading: customersLoading } = useQuery({
    queryKey: ['customers', searchTerm, filterStatus],
    queryFn: async () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      key: "customers",
      children: [
        { label: "Customer List", href: "/customers", active: true },
  ...
  // Mock data for customers (replace with actual data from API)
  const mockCustomers = customers || [
    ...
    },
    {
      ...
      address: "Calle Mayor 1, Madrid, Spain 28013",
      nationality: "Spanish",
      total_bookings: 6,
      total_spent: 3150.00,
        ...
        <main className="p-4 md:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
              ...
              <p className="text-[#8A94A7] dark:text-[#A0A0A0]">
                Manage your hotel guests and customer information
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">1,247</p>
                </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">New This Month</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">89</p>
                </div>
                <div className="w-12 h-12 bg-[#ECFDF5] dark:bg-[#064E3B] rounded-lg flex items-center justify-center">
                  <User size={24} className="text-[#10B981] dark:text-[#34D399]" />
                </div>
              </div>
              <div className="flex items-center mt-4">
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Repeat Customers</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">456</p>
                </div>
              ...
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">+15%</span>
                <span className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm ml-2">vs last month</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">$2,340</p>
                </div>
          ...
          <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] overflow-hidden" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-[#EDF0F4] dark:divide-[#333333]">
                  {mockCustomers.map((customer) => (
                    <tr key={customer.id} className="hover:bg-[#F7F9FC] dark:hover:bg-[#262626] transition-colors">
            ...
            <div className="px-6 py-4 border-t border-[#EDF0F4] dark:border-[#333333] flex items-center justify-between">
              <div className="text-sm text-[#8A94A7] dark:text-[#A0A0A0]">
                Showing 1 to 5 of 1,247 customers
              </div>
              <div className="flex items-center space-x-2">
