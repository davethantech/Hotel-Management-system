...
export default function MenuItemsPage() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      key: "pos",
      children: [
        { label: "Menu Items", href: "/pos-management/menu-items", active: true },
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'out_of_stock':
        return <AlertCircle size={16} className="text-[#E12929]" />;
      default:
        ...
        <main className="p-4 md:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            ...
            <div className="flex items-center space-x-3 mt-4 sm:mt-0">
              ...
              <a
                href="/pos-management/menu-items/add"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">156</p>
                </div>
                <div className="w-12 h-12 bg-[#E8F0FF] dark:bg-[#1A2332] rounded-lg flex items-center justify-center">
                  <ShoppingCart size={24} className="text-[#4F8BFF] dark:text-[#5B94FF]" />
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Available</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">142</p>
                </div>
                <div className="w-12 h-12 bg-[#ECFDF5] dark:bg-[#064E3B] rounded-lg flex items-center justify-center">
                  <Check size={24} className="text-[#10B981] dark:text-[#34D399]" />
                </div>
              </div>
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">91%</span>
                <span className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm ml-2">availability rate</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">$16.40</p>
                </div>
                <div className="w-12 h-12 bg-[#FEF3C7] dark:bg-[#451A03] rounded-lg flex items-center justify-center">
                  <DollarSign size={24} className="text-[#F59E0B] dark:text-[#FCD34D]" />
                </div>
              </div>
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">+$2.10</span>
                <span className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm ml-2">vs last month</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Top Rated</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">4.7★</p>
                </div>
                <div className="w-12 h-12 bg-[#DBEAFE] dark:bg-[#1E3A8A] rounded-lg flex items-center justify-center">
                  <Star size={24} className="text-[#3B82F6] dark:text-[#60A5FA]" />
                </div>
              </div>
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">+0.2</span>
                <span className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm ml-2">avg rating</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] overflow-hidden" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-[#EDF0F4] dark:divide-[#333333]">
                  {mockMenuItems.map((item) => (
                    <tr key={item.id} className="hover:bg-[#F7F9FC] dark:hover:bg-[#262626] transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {item.stock <= 5 && item.stock > 0 && (
                          <div className="text-xs text-[#F59E0B] dark:text-[#FCD34D]">
                            Low stock
                          </div>
                        )}
                      </td>
            ...
            <div className="px-6 py-4 border-t border-[#EDF0F4] dark:border-[#333333] flex items-center justify-between">
              <div className="text-sm text-[#8A94A7] dark:text-[#A0A0A0]">
                Showing 1 to 5 of 156 menu items
              </div>
              <div className="flex items-center space-x-2">
