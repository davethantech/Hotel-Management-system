  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "HR Staff", href: "/hr/staff", active: true },
  ...
  const mockHRStaff = [
    {
      ...
      email: "jennifer.adams@hotel.com",
    ...
    },
    {
      ...
      department: "Human Resources",
      email: "michael.torres@hotel.com",
    ...
    },
    {
      ...
      phone: "+1 (555) 201-5678",
      status: "active",
      hire_date: "2022-07-10",
      salary: 65000,
      location: "HR Office",
      experience: "4 years",
      certifications: ["CIR", "PHR"]
    },
    {
      id: 4,
      employee_id: "HR004",
      ...
      department: "Human Resources",
      email: "david.kumar@hotel.com",
      phone: "+1 (555) 201-6789",
      status: "on_leave",
      hire_date: "2021-11-08",
      salary: 62000,
      location: "Training Center",
      experience: "5 years",
      certifications: ["CPTD", "ATD"]
    },
    {
      id: 5,
      employee_id: "HR005",
        ...
        <main className="p-4 md:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
              ...
              <p className="text-[#8A94A7] dark:text-[#A0A0A0]">
                Manage your human resources team and their specializations
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Total HR Staff</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">12</p>
                </div>
              ...
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">+2</span>
                <span className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm ml-2">vs last quarter</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Active Staff</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">11</p>
                </div>
              ...
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">92%</span>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Certifications</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">18</p>
                </div>
                <div className="w-12 h-12 bg-[#FEF3C7] dark:bg-[#451A03] rounded-lg flex items-center justify-center">
                  <Award size={24} className="text-[#F59E0B] dark:text-[#FCD34D]" />
                </div>
              </div>
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">1.5</span>
                <span className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm ml-2">avg per staff</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#8A94A7] dark:text-[#A0A0A0] text-sm font-medium">Avg Experience</p>
                  <p className="text-[#07111F] dark:text-[#E5E5E5] text-2xl font-bold mt-1">5.2y</p>
                </div>
                <div className="w-12 h-12 bg-[#DBEAFE] dark:bg-[#1E3A8A] rounded-lg flex items-center justify-center">
                  <Badge size={24} className="text-[#3B82F6] dark:text-[#60A5FA]" />
                </div>
              </div>
              <div className="flex items-center mt-4">
                <span className="text-[#10B981] dark:text-[#34D399] text-sm font-medium">+0.8y</span>
          ...
          <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-[#EDF0F4] dark:border-[#333333] overflow-hidden" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="flex items-center mt-1 space-x-1">
                          {staff.certifications.map((cert, index) => (
                            <span key={index} className="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-[#E8F0FF] dark:bg-[#1A2332] text-[#4F8BFF] dark:text-[#5B94FF]">
                              {cert}
                            </span>
                          ))}
                        </div>
            ...
            <div className="px-6 py-4 border-t border-[#EDF0F4] dark:border-[#333333] flex items-center justify-between">
              <div className="text-sm text-[#8A94A7] dark:text-[#A0A0A0]">
                Showing 1 to 5 of 12 HR staff members
              </div>
              <div className="flex items-center space-x-2">
